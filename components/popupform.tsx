...
export default function PopupForm({ isOpen: externalIsOpen, onClose, trigger, showDefaultButton = true }: PopupFormProps) {
  ...
  const modalContent = isOpen ? (
    ...
    >
      <div 
        className="bg-gradient-to-br from-slate-800/95 via-purple-900/90 to-slate-900/95 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-5xl max-h-[95vh] overflow-y-auto relative border border-purple-500/20"
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 right-4 sm:top-6 sm:right-6 p-2 sm:p-3 rounded-full bg-white/10 hover:bg-red-500/80 transition-all duration-300 hover:rotate-90 hover:scale-110 z-20 group backdrop-blur-sm border border-white/20"
        >
        ...
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <div className="relative bg-gradient-to-br from-blue-900/40 to-purple-900/40 p-6 md:p-8 lg:p-10 flex items-center justify-center overflow-hidden min-h-[300px] md:min-h-0">
            {/* Animated Background Elements */}
            <div className="absolute top-0 right-0 w-32 sm:w-48 h-32 sm:h-48 bg-purple-500/20 rounded-full blur-3xl" style={{ animation: 'pulseSlow 4s ease-in-out infinite' }} />
            <div className="absolute bottom-0 left-0 w-32 sm:w-48 h-32 sm:h-48 bg-blue-500/20 rounded-full blur-3xl" style={{ animation: 'pulseSlow 4s ease-in-out infinite', animationDelay: '1s' }} />
            ...
            <div className="relative z-10 text-center space-y-4 sm:space-y-6">
              ...
              <div className="relative">
                <svg viewBox="0 0 400 500" className="w-full max-w-[250px] sm:max-w-md mx-auto" style={{ animation: 'float 3s ease-in-out infinite' }}>
              ...
              <div className="space-y-2 sm:space-y-3" style={{ animation: 'slideUp 0.5s ease-out' }}>
                ...
                <div className="inline-block px-4 sm:px-6 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full" style={{ animation: 'pulseSlow 4s ease-in-out infinite' }}>
          ...
          <div className="relative z-10 p-6 md:p-8 lg:p-10">
            <div className="mb-4 sm:mb-6">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2" style={{ animation: 'slideDown 0.5s ease-out' }}>
                Request a Callback
              </h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-4" style={{ animation: 'slideRight 0.5s ease-out', animationDelay: '0.3s', animationFillMode: 'backwards' }}>
                <select
                  name="countryCode"
                  value={formData.countryCode}
                  onChange={handleChange}
                  className="col-span-1 px-2 py-3 bg-transparent border-b-2 border-gray-600 text-white focus:outline-none focus:border-purple-500 transition-all duration-300 text-xs sm:text-sm md:text-base"
                >
    ...
    <>
      ...
      {trigger ? (
        ...
        <button
          ...
          className="group relative px-6 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 text-white font-bold rounded-2xl overflow-hidden transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:shadow-purple-500/50"
        >
          <span className="relative z-10 flex items-center gap-2 sm:gap-3 text-base sm:text-lg">
            <Sparkles className="w-5 h-5 sm:w-6 sm:h-6 group-hover:rotate-180 transition-transform duration-700" />
            Request a Callback
