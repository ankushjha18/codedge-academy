  ...
  const highlights = [
    {
      ...
      description: ' Achieve true work-life balance with schedules that respect your personal commitments.',
    ...
    },
    {
      ...
      description: 'Work from anywhere without compromising on collaboration or growth..',
      iconBg: 'bg-orange-500',
      iconColor: 'text-orange-500'
    },
    {
      ...
      description: ' Get access to certifications, workshops, and upskilling opportunities powered by Codedge Academy.',
      iconBg: 'bg-orange-500',
      iconColor: 'text-orange-500'
    },
    {
      ...
      description: 'Collaborate with industry experts, global clients, and innovative projects shaping the future.',
      iconColor: 'text-orange-500'
    },
    {
      icon: GraduationCap,
      title: 'Growth Opportunities',
      description: 'Accelerate your career with clear pathways, mentorship, and leadership programs',
      iconBg: 'bg-orange-500',
      iconColor: 'text-orange-500'
    },
    {
      ...
      description: 'Comprehensive health plans, wellness activities, and initiatives to keep you at your best.',
      iconBg: 'bg-orange-500',
      iconColor: 'text-orange-500'
    }
  ];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="pt-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-12">
           Discover the Benefits of Working at Codedge Academy
          </h2>
          <p className="text-gray-700 text-lg leading-relaxed mb-12">
            We believe great people deserve a great workplace. That’s why we empower our team with world-class benefits designed to support their growth, balance, and success.</p>
